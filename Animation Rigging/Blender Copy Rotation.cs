...
namespace BlenderConstraints
{
    ...
    public class BlenderCopyRotation : RigConstraint<BlenderCopyRotationJob, BlenderCopyRotationData, BlenderCopyRotationBinder>, IBlenderConstraint
    {
        ...
        public IBlenderConstraint ConvertComponent(bool useAnimationRigging, bool updateInEditMode = true, UpdateMode updateMode = UpdateMode.Update)
        {
            ...
            var simpleConstraint = Undo.AddComponent<BlenderCopyRotationSimple>(this.gameObject);
            Undo.RecordObject(simpleConstraint, "clone constraints settings");
            ...
            simpleConstraint.targetRestPose = Quaternion.Euler(data.savedRotationTarget);
            simpleConstraint.order = data.eulerAxisOrder;
            simpleConstraint.mask = data.includedAxes;
